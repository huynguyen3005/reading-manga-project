...
<body class="sticky-header">
    <!-- Preloader -->
    <div id="preloader">
        <img src="assets/media/Anime-loop-preloader-white.gif" alt="preloader" class="mb-5">
    </div>
    <!-- Back To Top Start -->
        ...
        <header class="header style-1">
            <div class="container">
                ...
                <nav class="navbar navbar-expand-lg">
                    <a class="navbar-brand" href="home.html"><img src="assets/media/logo.png" alt=""></a>
                    ...
                    <div class="banner-content">
                        <div class="row ">
                            <div class="col-lg-5 col-12 ">
                                ...
                                <a class="play-butn" href="streaming-season.html">PLAY NOW</a>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="anime-blog">
                            <div class="img-block">
                                ...
                                <div class="action-overlay"><a href="streaming-season.html"><i
                                            class="fal fa-play-circle"></i> Play Now</a></div>
                            </div>
                            <div class="detail">
                                <div class="tags">
                                    <a href="streaming-season.html" class="text-box">dub</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu bg-color-black pt-3 pb-3 ps-3 pe-3">
                                        <li><a href="#" class="none"><i class="fa fa-check"></i> Watch Later
                                            </a></li>
                                        <li><a href="#"><i class="fas fa-plus"></i> Add to Playlist </a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade show active" id="sunday">
                                <a href="streaming-season.html">
                                    <div class="row  align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-10 col-12">
                                            <div class="row  align-items-center">
                                                <div
                                                    ...
                                                    <img src="assets/media/anime-sm-img/anime-img-1.png"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-0 col-0 text-end">
                                    ...
                                    <div class="row  align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-10 col-12">
                                            <div class="row  align-items-center">
                                                <div
                                                    class="col-xl-1 col-lg-2 col-md-2 col-sm-2 col-3 ps-0 pe-0 text-end">
                                                    <img src="assets/media/anime-sm-img/anime-img-2.png"
                                                        alt="">
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-7 col-9">
                                                    <div class="schedule-content align-middle">
                                    ...
                                    <div class="row  align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-10 col-12">
                                            <div class="row  align-items-center">
                                                <div
                                                    class="col-xl-1 col-lg-2 col-md-2 col-sm-2 col-3 ps-0 pe-0 text-end">
                                                    <img src="assets/media/anime-sm-img/anime-img-3.png"
                                                        alt="">
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-7 col-9">
                                                    <div class="schedule-content align-middle">
                                    ...
                                    <div class="row  align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-10 col-12">
                                            <div class="row  align-items-center">
                                                <div
                                                    class="col-xl-1 col-lg-2 col-md-2 col-sm-2 col-3 ps-0 pe-0 text-end">
                                                    <img src="assets/media/anime-sm-img/anime-img-4.png"
                                                        alt="">
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-7 col-9">
                                                    <div class="schedule-content align-middle">
                                    ...
                                    <div class="row  align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-10 col-12">
                                            <div class="row  align-items-center">
                                                <div
                                                    class="col-xl-1 col-lg-2 col-md-2 col-sm-2 col-3 ps-0 pe-0 text-end">
                                                    <img src="assets/media/anime-sm-img/anime-img-5.png"
                                                        alt="">
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-7 col-9">
                                                    <div class="schedule-content align-middle">
                                    ...
                                    <div class="row  align-items-center">
                                        ...
                                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-10 col-12">
                                            <div class="row  align-items-center">
                                                <div
                                                    class="col-xl-1 col-lg-2 col-md-2 col-sm-2 col-3 ps-0 pe-0 text-end">
                                                    <img src="assets/media/anime-sm-img/anime-img-6.png"
                                                        alt="">
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-7 col-9">
                                                    <div class="schedule-content align-middle">
                        ...
                        <a href="blog-detail.html" class="inner-box">
                            ...
                            <div class="author-box text-start">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="assets/media/comment/comment-img-2.png" class="w-auto"
                                        alt="">
                                    <h5>Author’s Name</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 offset-lg-0 offset-md-0 offset-sm-2 col-12">
                        <a href="blog-detail.html" class="inner-box">
                            ...
                            <div class="author-box text-start">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="assets/media/comment/comment-img-3.png" class="w-auto"
                                        alt="">
                                    <h5>Author’s Name</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 offset-lg-0 offset-md-3 offset-sm-2 col-12">
                        <a href="blog-detail.html" class="inner-box">
                            ...
                            <div class="author-box text-start">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="assets/media/comment/comment-img-4.png" class="w-auto"
                                        alt="">
                                    <h5>Author’s Name</h5>
                                </div>
                            </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-5 col-sm-12 col-12">
                            <div class="footer-widget">
                                ...
                                <p class="mb-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum
                                    modi, possimus dolore saepe nobis itaque cupiditate veniam nostrum,
                                    provident quam, nequeab dicta velit debitis cum unde recusandae. Fuga,
                                    consectetur.</p>
                                <h6 class="mb-2">Join Us on</h6>
                                <ul class="social-icons">
                                    <li><a href="#"><img alt=""
                                                src="assets/media/footer/reddit.png"></a></li>
                                    <li><a href="#"><img alt=""
                                                src="assets/media/footer/discord.png"></a></li>
                                    <li><a href="#"><img alt=""
                                                src="assets/media/footer/instagram.png"></a></li>
                                    <li><a href="#"><img alt=""
                                                src="assets/media/footer/twitter.png"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-7 col-sm-12 col-12">
                            <div class="footer-widget align-middle">
                                <h6>GET NOTIFIED</h6>
                                <p class="light-text">Get emails for latest news about anime, and more.</p>
                                ...
                                <P class="text">By subscribing you agree to our terms and conditions</P>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="footer-copyright">
                                <span class="copyright-text">© 2024 All rights reserved by <a
                                        href="#">Animeloop</a>.</span>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="footer-bottom-link text-end">
                                <a href="privacy.html">Privacy Policy</a>
                                <a href="comments.html" class="ps-2">Comments Policy</a>
                            </div>
                        </div>
                    </div>
                </div>
